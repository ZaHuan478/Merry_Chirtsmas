...
export const createParticleSystem = (scene, type, count, size) => {
  const pPositions = []
...
export const updateParticleGroup = (group, type, targetState, speed, handRotY, time) => {
  if (!group) return
  ...
  // Update colors and sizes based on state
